...
namespace WindowsFormsApp4
{
    public partial class Form26 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "t");
            textBox2.Text = textBox2.Text.Replace("2", "u");
            textBox2.Text = textBox2.Text.Replace("3", "ü");
            textBox2.Text = textBox2.Text.Replace("‼", "v");
            textBox2.Text = textBox2.Text.Replace("4", "y");
            textBox2.Text = textBox2.Text.Replace("5", "z");
            textBox2.Text = textBox2.Text.Replace("6", "a");
            textBox2.Text = textBox2.Text.Replace("7", "b");
            textBox2.Text = textBox2.Text.Replace("8", "c");
            textBox2.Text = textBox2.Text.Replace("9", "ç");
            textBox2.Text = textBox2.Text.Replace("0", "d");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "f");
            textBox2.Text = textBox2.Text.Replace("2", "g");
            textBox2.Text = textBox2.Text.Replace("3", "ğ");
            textBox2.Text = textBox2.Text.Replace("‼", "h");
            textBox2.Text = textBox2.Text.Replace("4", "ı");
            textBox2.Text = textBox2.Text.Replace("5", "i");
            textBox2.Text = textBox2.Text.Replace("6", "j");
            textBox2.Text = textBox2.Text.Replace("7", "k");
            textBox2.Text = textBox2.Text.Replace("8", "l");
            textBox2.Text = textBox2.Text.Replace("9", "m");
            textBox2.Text = textBox2.Text.Replace("0", "n");
            textBox2.Text = textBox2.Text.Replace("*", "o");
            textBox2.Text = textBox2.Text.Replace("-", "ö");
            textBox2.Text = textBox2.Text.Replace("☺", "p");
            textBox2.Text = textBox2.Text.Replace("☻", "r");
