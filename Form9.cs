...
namespace WindowsFormsApp4
{
    public partial class Form9 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "g");
            textBox2.Text = textBox2.Text.Replace("2", "ğ");
            textBox2.Text = textBox2.Text.Replace("3", "h");
            textBox2.Text = textBox2.Text.Replace("‼", "ı");
            textBox2.Text = textBox2.Text.Replace("4", "i");
            textBox2.Text = textBox2.Text.Replace("5", "j");
            textBox2.Text = textBox2.Text.Replace("6", "k");
            textBox2.Text = textBox2.Text.Replace("7", "l");
            textBox2.Text = textBox2.Text.Replace("8", "m");
            textBox2.Text = textBox2.Text.Replace("9", "n");
            textBox2.Text = textBox2.Text.Replace("0", "o");
