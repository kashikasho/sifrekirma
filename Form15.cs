...
namespace WindowsFormsApp4
{
    public partial class Form15 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "k");
            textBox2.Text = textBox2.Text.Replace("2", "l");
            textBox2.Text = textBox2.Text.Replace("3", "m");
            textBox2.Text = textBox2.Text.Replace("‼", "n");
            textBox2.Text = textBox2.Text.Replace("4", "o");
            textBox2.Text = textBox2.Text.Replace("5", "ö");
            textBox2.Text = textBox2.Text.Replace("6", "p");
            textBox2.Text = textBox2.Text.Replace("7", "r");
            textBox2.Text = textBox2.Text.Replace("8", "s");
            textBox2.Text = textBox2.Text.Replace("9", "ş");
            textBox2.Text = textBox2.Text.Replace("0", "t");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "n");
            textBox2.Text = textBox2.Text.Replace("2", "o");
            textBox2.Text = textBox2.Text.Replace("3", "ö");
            textBox2.Text = textBox2.Text.Replace("‼", "p");
            textBox2.Text = textBox2.Text.Replace("4", "r");
            textBox2.Text = textBox2.Text.Replace("5", "s");
            textBox2.Text = textBox2.Text.Replace("6", "ş");
            textBox2.Text = textBox2.Text.Replace("7", "t");
            textBox2.Text = textBox2.Text.Replace("8", "u");
            textBox2.Text = textBox2.Text.Replace("9", "ü");
            textBox2.Text = textBox2.Text.Replace("0", "v");
            textBox2.Text = textBox2.Text.Replace("*", "y");
            textBox2.Text = textBox2.Text.Replace("-", "z");
            textBox2.Text = textBox2.Text.Replace("☺", "a");
            textBox2.Text = textBox2.Text.Replace("☻", "b");
