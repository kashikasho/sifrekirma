...
namespace WindowsFormsApp4
{
    public partial class Form16 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "l");
            textBox2.Text = textBox2.Text.Replace("2", "m");
            textBox2.Text = textBox2.Text.Replace("3", "n");
            textBox2.Text = textBox2.Text.Replace("‼", "o");
            textBox2.Text = textBox2.Text.Replace("4", "ö");
            textBox2.Text = textBox2.Text.Replace("5", "p");
            textBox2.Text = textBox2.Text.Replace("6", "r");
            textBox2.Text = textBox2.Text.Replace("7", "s");
            textBox2.Text = textBox2.Text.Replace("8", "ş");
            textBox2.Text = textBox2.Text.Replace("9", "t");
            textBox2.Text = textBox2.Text.Replace("0", "u");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "m");
            textBox2.Text = textBox2.Text.Replace("2", "n");
            textBox2.Text = textBox2.Text.Replace("3", "o");
            textBox2.Text = textBox2.Text.Replace("‼", "ö");
            textBox2.Text = textBox2.Text.Replace("4", "p");
            textBox2.Text = textBox2.Text.Replace("5", "r");
            textBox2.Text = textBox2.Text.Replace("6", "s");
            textBox2.Text = textBox2.Text.Replace("7", "ş");
            textBox2.Text = textBox2.Text.Replace("8", "t");
            textBox2.Text = textBox2.Text.Replace("9", "u");
            textBox2.Text = textBox2.Text.Replace("0", "ü");
            textBox2.Text = textBox2.Text.Replace("*", "v");
            textBox2.Text = textBox2.Text.Replace("-", "y");
            textBox2.Text = textBox2.Text.Replace("☺", "z");
            textBox2.Text = textBox2.Text.Replace("☻", "a");
