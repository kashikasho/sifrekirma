...
namespace WindowsFormsApp4
{
    public partial class Form29 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "v");
            textBox2.Text = textBox2.Text.Replace("2", "y");
            textBox2.Text = textBox2.Text.Replace("3", "z");
            textBox2.Text = textBox2.Text.Replace("‼", "a");
            textBox2.Text = textBox2.Text.Replace("4", "b");
            textBox2.Text = textBox2.Text.Replace("5", "c");
            textBox2.Text = textBox2.Text.Replace("6", "ç");
            textBox2.Text = textBox2.Text.Replace("7", "d");
            textBox2.Text = textBox2.Text.Replace("8", "e");
            textBox2.Text = textBox2.Text.Replace("9", "f");
            textBox2.Text = textBox2.Text.Replace("0", "g");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "ç");
            textBox2.Text = textBox2.Text.Replace("2", "d");
            textBox2.Text = textBox2.Text.Replace("3", "e");
            textBox2.Text = textBox2.Text.Replace("‼", "f");
            textBox2.Text = textBox2.Text.Replace("4", "g");
            textBox2.Text = textBox2.Text.Replace("5", "ğ");
            textBox2.Text = textBox2.Text.Replace("6", "h");
            textBox2.Text = textBox2.Text.Replace("7", "i");
            textBox2.Text = textBox2.Text.Replace("8", "ı");
            textBox2.Text = textBox2.Text.Replace("9", "j");
            textBox2.Text = textBox2.Text.Replace("0", "k");
            textBox2.Text = textBox2.Text.Replace("*", "l");
            textBox2.Text = textBox2.Text.Replace("-", "m");
            textBox2.Text = textBox2.Text.Replace("☺", "n");
            textBox2.Text = textBox2.Text.Replace("☻", "o");
