...
namespace WindowsFormsApp4
{
    public partial class Form24 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "s");
            textBox2.Text = textBox2.Text.Replace("2", "ş");
            textBox2.Text = textBox2.Text.Replace("3", "t");
            textBox2.Text = textBox2.Text.Replace("‼", "u");
            textBox2.Text = textBox2.Text.Replace("4", "ü");
            textBox2.Text = textBox2.Text.Replace("5", "v");
            textBox2.Text = textBox2.Text.Replace("6", "y");
            textBox2.Text = textBox2.Text.Replace("7", "z");
            textBox2.Text = textBox2.Text.Replace("8", "a");
            textBox2.Text = textBox2.Text.Replace("9", "b");
            textBox2.Text = textBox2.Text.Replace("0", "c");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "ğ");
            textBox2.Text = textBox2.Text.Replace("2", "h");
            textBox2.Text = textBox2.Text.Replace("3", "ı");
            textBox2.Text = textBox2.Text.Replace("‼", "i");
            textBox2.Text = textBox2.Text.Replace("4", "j");
            textBox2.Text = textBox2.Text.Replace("5", "k");
            textBox2.Text = textBox2.Text.Replace("6", "l");
            textBox2.Text = textBox2.Text.Replace("7", "m");
            textBox2.Text = textBox2.Text.Replace("8", "n");
            textBox2.Text = textBox2.Text.Replace("9", "o");
            textBox2.Text = textBox2.Text.Replace("0", "ö");
            textBox2.Text = textBox2.Text.Replace("*", "p");
            textBox2.Text = textBox2.Text.Replace("-", "r");
