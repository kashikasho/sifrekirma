...
namespace WindowsFormsApp4
{
    public partial class Form14 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "j");
            textBox2.Text = textBox2.Text.Replace("2", "k");
            textBox2.Text = textBox2.Text.Replace("3", "l");
            textBox2.Text = textBox2.Text.Replace("‼", "m");
            textBox2.Text = textBox2.Text.Replace("4", "n");
            textBox2.Text = textBox2.Text.Replace("5", "o");
            textBox2.Text = textBox2.Text.Replace("6", "ö");
            textBox2.Text = textBox2.Text.Replace("7", "p");
            textBox2.Text = textBox2.Text.Replace("8", "r");
            textBox2.Text = textBox2.Text.Replace("9", "s");
            textBox2.Text = textBox2.Text.Replace("0", "ş");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "o");
            textBox2.Text = textBox2.Text.Replace("2", "ö");
            textBox2.Text = textBox2.Text.Replace("3", "p");
            textBox2.Text = textBox2.Text.Replace("‼", "r");
            textBox2.Text = textBox2.Text.Replace("4", "s");
            textBox2.Text = textBox2.Text.Replace("5", "ş");
            textBox2.Text = textBox2.Text.Replace("6", "t");
            textBox2.Text = textBox2.Text.Replace("7", "u");
            textBox2.Text = textBox2.Text.Replace("8", "ü");
            textBox2.Text = textBox2.Text.Replace("9", "v");
            textBox2.Text = textBox2.Text.Replace("0", "y");
            textBox2.Text = textBox2.Text.Replace("*", "z");
            textBox2.Text = textBox2.Text.Replace("-", "a");
            textBox2.Text = textBox2.Text.Replace("☺", "b");
            textBox2.Text = textBox2.Text.Replace("☻", "c");
