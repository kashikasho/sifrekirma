...
namespace WindowsFormsApp4
{
    public partial class Form22 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "p");
            textBox2.Text = textBox2.Text.Replace("2", "r");
            textBox2.Text = textBox2.Text.Replace("3", "s");
            textBox2.Text = textBox2.Text.Replace("‼", "ş");
            textBox2.Text = textBox2.Text.Replace("4", "t");
            textBox2.Text = textBox2.Text.Replace("5", "u");
            textBox2.Text = textBox2.Text.Replace("6", "ü");
            textBox2.Text = textBox2.Text.Replace("7", "v");
            textBox2.Text = textBox2.Text.Replace("8", "y");
            textBox2.Text = textBox2.Text.Replace("9", "z");
            textBox2.Text = textBox2.Text.Replace("0", "a");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "ı");
            textBox2.Text = textBox2.Text.Replace("2", "i");
            textBox2.Text = textBox2.Text.Replace("3", "j");
            textBox2.Text = textBox2.Text.Replace("‼", "k");
            textBox2.Text = textBox2.Text.Replace("4", "l");
            textBox2.Text = textBox2.Text.Replace("5", "m");
            textBox2.Text = textBox2.Text.Replace("6", "n");
            textBox2.Text = textBox2.Text.Replace("7", "o");
            textBox2.Text = textBox2.Text.Replace("8", "ö");
            textBox2.Text = textBox2.Text.Replace("9", "p");
            textBox2.Text = textBox2.Text.Replace("0", "r");
