...
namespace WindowsFormsApp4
{
    public partial class Form27 : Form
    {
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "u");
            textBox2.Text = textBox2.Text.Replace("2", "ü");
            textBox2.Text = textBox2.Text.Replace("3", "v");
            textBox2.Text = textBox2.Text.Replace("‼", "y");
            textBox2.Text = textBox2.Text.Replace("4", "z");
            textBox2.Text = textBox2.Text.Replace("5", "a");
            textBox2.Text = textBox2.Text.Replace("6", "b");
            textBox2.Text = textBox2.Text.Replace("7", "c");
            textBox2.Text = textBox2.Text.Replace("8", "ç");
            textBox2.Text = textBox2.Text.Replace("9", "d");
            textBox2.Text = textBox2.Text.Replace("0", "e");
        ...
        {
            textBox2.Text = textBox2.Text.Replace("1", "e");
            textBox2.Text = textBox2.Text.Replace("2", "f");
            textBox2.Text = textBox2.Text.Replace("3", "g");
            textBox2.Text = textBox2.Text.Replace("‼", "ğ");
            textBox2.Text = textBox2.Text.Replace("4", "h");
            textBox2.Text = textBox2.Text.Replace("5", "ı");
            textBox2.Text = textBox2.Text.Replace("6", "i");
            textBox2.Text = textBox2.Text.Replace("7", "j");
            textBox2.Text = textBox2.Text.Replace("8", "k");
            textBox2.Text = textBox2.Text.Replace("9", "l");
            textBox2.Text = textBox2.Text.Replace("0", "m");
            textBox2.Text = textBox2.Text.Replace("*", "n");
            textBox2.Text = textBox2.Text.Replace("-", "o");
            textBox2.Text = textBox2.Text.Replace("☺", "ö");
            textBox2.Text = textBox2.Text.Replace("☻", "p");
